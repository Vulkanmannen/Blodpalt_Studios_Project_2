...
LevelFail::LevelFail(unsigned int levelJustClear) :
mNextLevel( levelJustClear)
...
void LevelFail::buttonAnimation(Super &r_super)
{
...
void LevelFail::update(Super &r_super)
{
...
void LevelFail::draw(Super &r_super) 
{
